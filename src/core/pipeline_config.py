...
def load_pipeline_config(config_path: str | Path = "config.json", repo_name: str | None = None) -> PipelineConfig:
    ...
    return PipelineConfig(
        ...
        embedding_url=embed_model.get("url") or os.environ.get("OLLAMA_URL") or "http://localhost:11434",
        describer_url=describer_model.get("url") or os.environ.get("OLLAMA_URL") or "http://localhost:11434",
