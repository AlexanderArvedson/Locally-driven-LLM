...
Cohesion: 0.10
Nodes (38): Node, Parser, _build_slice(), _collect_names(), _find_symbol(), _get_docstring(), _import_exposes_used_name(), _is_contract() (+30 more)

### Community 2 - "Community 2"
Cohesion: 0.15
Nodes (22): OllamaClient, PipelineConfig, Description service for LLM-generated function summaries.  Wraps ``OllamaClient., Embedding service for code and description vectors.  Wraps ``OllamaClient.embed(, QueryMatch, QueryResult, Semantic search engine for functions stored in Neo4j.  Embeds a free-text query, A single function returned by a semantic search. (+14 more)

### Community 3 - "Test Infrastructure & Fixtures"
Cohesion: 0.23
Nodes (15): build_repository_context_payload(), _dedupe_preserve_order(), DependencySummaryItem, _normalize_path(), Versioned contract for retrieval -> coder repository context payloads.  This mod, Validate structural invariants for a repository context payload., Build a versioned, deterministic context payload from ContextPackage., _target_first() (+7 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (69): create_app(), _make_signature_verifier(), FastAPI application.  Provides a health check endpoint. Slack slash commands are, Create and return the FastAPI application., Return a FastAPI dependency that validates X-Slack-Signature on every request., Create and return the FastAPI application.      Args:         queue: The shared, _build_pipeline_blocks(), _build_report_blocks() (+61 more)
...
Cohesion: 0.14
Nodes (13): Symbol-level context slicing for language-agnostic code extraction., LanguageSlicer, Language-agnostic slicing Protocol.  Defines the shared contract that every lang, Everything extracted about one symbol from a source file., Extract and stitch back a named symbol within a source file., Return a SymbolSlice for the named function/class, or None if not found., Return import lines that are actually referenced by the named symbol., If method_name is a method, return its enclosing class header + docstring. (+5 more)
...
Cohesion: 0.12
Nodes (27): load_pipeline_config(), Pipeline configuration loader.  Reads the top-level ``neo4j`` block and the per-, Load pipeline configuration for a repository.      Args:         config_path: Pa, Load pipeline configuration for a repository.      Args:         config_path: Pa, Load pipeline configuration for a repository.      Args:         config_path: Pa, Load pipeline configuration for a repository.      Args:         config_path: Pa, _require_env(), _validate_timezone() (+19 more)
...
- **Why does `GraphState` connect `Community 40` to `Community 33`, `Community 36`, `Community 69`, `Community 39`, `Community 72`, `Community 9`, `Community 12`, `Community 19`, `Community 54`, `Community 26`, `Community 28`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.234) - this node is a cross-community bridge._
- **Why does `OllamaClient` connect `Community 2` to `Community 32`, `Community 4`, `LLM Pipeline & Sandbox`, `Community 10`, `Community 19`, `Community 57`, `Community 63`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `Neo4jStore` connect `Community 48` to `Community 2`, `Community 67`, `Community 4`, `Community 71`, `Community 41`, `Community 10`, `Community 75`, `Community 44`, `Community 46`, `Community 58`?**
