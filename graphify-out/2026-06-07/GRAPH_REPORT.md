...
## Corpus Check
- 79 files · ~30,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1099 nodes · 2362 edges · 78 communities (64 shown, 14 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 549 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae4a5c60`
...
Cohesion: 0.22
Nodes (16): OllamaClient, PipelineConfig, Embedding service for code and description vectors.  Wraps ``OllamaClient.embed(, QueryMatch, QueryResult, Semantic search engine for functions stored in Neo4j.  Embeds a free-text query, A single function returned by a semantic search., Aggregated result from a semantic search over the Neo4j vector indexes. (+8 more)
...
Cohesion: 0.20
Nodes (11): EmbeddingPipeline, Orchestrates all pipeline stages for a single repository., PipelineTask, QueryTask, ReportTask, Routes Task instances to the appropriate handler.      Resources (OllamaClient,, Routes Task instances to the appropriate handler.      Resources (OllamaClient,, Routes Task instances to the appropriate handler.      Resources (OllamaClient, (+3 more)
...
Cohesion: 0.09
Nodes (21): LiteralString, _ddl(), Neo4jStore, Neo4j data store for Function nodes and SIMILAR_TO relationships.  Uses the offi, Async Neo4j driver wrapper for Function nodes and SIMILAR_TO edges., Async Neo4j driver wrapper for Function nodes and SIMILAR_TO edges., Async Neo4j driver wrapper for Function nodes and SIMILAR_TO edges., Idempotently create constraints and indexes.          Args:             vector_d (+13 more)
...
Cohesion: 0.16
Nodes (28): Neo4jStore, Neo4jConfig, ReporterConfig, _build_report(), _combined_sim(), _compute_cohesion_scores(), _cosine(), _find_previous_report() (+20 more)
...
Cohesion: 0.09
Nodes (38): Language, _extract_from_file(), _find_functions(), _get_class_name(), _get_identifier(), _get_name_token(), _get_property_name(), _get_ts_language() (+30 more)
...
Cohesion: 0.50
Nodes (4): _compute_clusters(), Build connected components from similarity edges via BFS.      Each node is iden, Build connected components from similarity edges via BFS.      Each node is iden, Build connected components from similarity edges via BFS.      Each node is iden
...
- **Why does `GraphState` connect `Community 45` to `Community 33`, `Community 66`, `Community 68`, `Community 39`, `Community 9`, `Community 59`, `Community 12`, `Community 28`, `Community 46`, `Community 19`, `Community 26`, `Community 27`, `Community 60`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.253) - this node is a cross-community bridge._
- **Why does `OllamaClient` connect `Community 2` to `Community 32`, `LLM Pipeline & Sandbox`, `Community 40`, `Community 73`, `Community 10`, `Community 49`, `Community 19`, `Community 52`, `Community 57`, `Community 58`?**
  _High betweenness centrality (0.223) - this node is a cross-community bridge._
- **Why does `datetime` connect `Community 31` to `Test Infrastructure & Fixtures`, `Community 46`, `Community 48`, `Community 58`, `Community 62`?**
