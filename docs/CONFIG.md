...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `name` | string | — | Model identifier as recognised by the provider (e.g. `"llama3"`, `"qwen2.5:7b"`, `"mistral"`). |
